...
extern "C" void app_main(void){
	...
	xTaskCreate(benchmark, "Task1", 70000, &params1, 1, &benchmarkTaskHandle1);
	...
	std::cout << "TOTAL RUNTIME:" << std::chrono::duration_cast<std::chrono::milliseconds>(end-start).count();
