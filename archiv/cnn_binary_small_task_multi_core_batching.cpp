...
void predict_SmallCnnActionBINARY8(double const * const x, double * pred) {
    ...
    xTaskCreatePinnedToCore(ConvTask, "Layer2", 2048, &layer2params, 1, &taskHandleArray[0], 0);
    xTaskCreatePinnedToCore(BatchNormalization3DTask, "Layer3", 2048, &layer3params, 1, &taskHandleArray[1], 0);
    xTaskCreatePinnedToCore(Step3DTask, "Layer4", 2048, &layer4params, 1, &taskHandleArray[2], 0);
    xTaskCreatePinnedToCore(MaxPoolTask, "Layer5", 2048, &layer5params, 1, &taskHandleArray[3], 0);
    xTaskCreatePinnedToCore(ConvTask, "Layer6", 2048, &layer6params, 1, &taskHandleArray[4], 0);
    xTaskCreatePinnedToCore(BatchNormalization3DTask, "Layer7", 2048, &layer7params, 1, &taskHandleArray[5], 0);
    xTaskCreatePinnedToCore(Step3DTask, "Layer8", 2048, &layer8params, 1, &taskHandleArray[6], 0);
    xTaskCreatePinnedToCore(MaxPoolTask, "Layer9", 2048, &layer9params, 1, &taskHandleArray[7], 0);
    xTaskCreatePinnedToCore(GemmTask, "Layer11", 2048, &layer11params, 1, &taskHandleArray[8], 0);
    xTaskCreatePinnedToCore(BatchNormalization1DTask, "Layer12", 2048, &layer12params, 1, &taskHandleArray[9], 0);
    xTaskCreatePinnedToCore(Step1DTask, "Layer13", 2048, &layer13params, 1, &taskHandleArray[10], 0);
    xTaskCreatePinnedToCore(GemmTask, "Layer14", 2048, &layer14params, 1, &taskHandleArray[11], 0);
    xTaskCreatePinnedToCore(LogSoftmaxTask, "Layer15", 2048, &layer15params, 1, &taskHandleArray[12], 0);
